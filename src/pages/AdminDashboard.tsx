...
import {
  ...
  PieChart as PieChartIcon, MessageSquare, Printer, Map as MapIcon, Film, Grid3x3,
} from "lucide-react";
...
type AdminTab = "dashboard" | "menu" | "categories" | "orders" | "analytics" | "map" | "coupons" | "settings" | "users" | "reviews" | "chat" | "videos" | "billing" | "vlogs" | "tables";

const VALID_TABS: AdminTab[] = ["dashboard", "menu", "categories", "orders", "analytics", "map", "coupons", "settings", "users", "reviews", "chat", "videos", "billing", "vlogs", "tables"];
